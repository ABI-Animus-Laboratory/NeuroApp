    ...
    loadModel(model_url, model_name) {
      ...
      if (this.$title() === "Healthy") {
        ...
        if (!this.scene) {
          ...
          const geometry1 = new this.THREE.BoxGeometry(100, 100, 100);
          const geometry2 = new this.THREE.BoxGeometry(100, 100, 100);
          const material = new this.THREE.MeshBasicMaterial({color: 'pink'});
          const cube1 = new this.THREE.Mesh(geometry1, material);
          const cube2 = new this.THREE.Mesh(geometry2, material);
          cube1.name = "cube1";
          cube2.name = "cube2";
